 ...
 * App.tsx already uses for its own single intro block, generalized to a
 * component-local set of CMS keys. CMS content isn't reactive by default,
 * so this re-fetches whenever `locale` changes.
 */
